  ...
  <div>
    <Head>
      ...
      <Meta
        ...
        content="Distributor resmi garam berkualitas tinggi dengan sertifikasi internasional. Melayani garam industri dan konsumsi ke seluruh Indonesia."
      />
      <Meta
        property="og:image"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center space-x-4 mb-6">
                <img
                  src="/bsa-logo.avif"
                  alt="Bahari Sentosa Abadi Logo"
                  class="h-16 w-16 rounded-full object-cover"
                />
                <div class="h-12 w-px bg-gray-300 dark:bg-gray-600"></div>
                <div>
                  <h2
                    class="text-2xl font-bold text-primary-600 dark:text-primary-400 font-heading"
                  >
                    Bahari Sentosa Abadi
                  </h2>
                  <p class="text-sm text-gray-600 dark:text-gray-400 font-body">
                    Distributor Garam Terpercaya
                  </p>
                </div>
              </div>
              ...
              >
                ...
                industri dan konsumsi sejak tahun 2019. Bahari Sentosa Abadi
              ...
              >
                ...
                >
                  ...
                  <p
                    class="text-base text-gray-600 dark:text-gray-400 leading-relaxed font-body"
                  >
                    Kami memastikan setiap pengiriman berjalan tepat waktu
                    dengan kualitas produk yang terjaga hingga tujuan.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p
                class="text-gray-700 dark:text-gray-300 font-body leading-relaxed"
              >
                Jaringan distribusi yang luas memungkinkan kami mengirimkan
                produk ke seluruh Indonesia dengan jadwal yang dapat diandalkan
                dan sistem tracking real-time.
              </p>
            </div>
              ...
              <div class="flex items-start space-x-4 group">
                ...
                <div class="flex-1">
                  ...
                  >
                    ...
                    produk lengkap untuk compliance perusahaan, dan dukungan
                    legal documentation.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div class="p-8">
                ...
                >
                  ...
                  otomatisasi penuh memastikan konsistensi kualitas dan
                  eliminasi kontaminan seperti kalsium, magnesium, dan logam
                  berat.
                </p>
            ...
            >
              ...
              <div class="p-8">
                ...
                <p
                  class="text-gray-700 dark:text-gray-300 font-body leading-relaxed mb-6"
                >
                  Diformulasi khusus untuk industri deterjen dan pembersih
                  dengan teknologi automatic & robotic system. Memiliki ukuran
                  partikel seragam dan dissolusi cepat untuk kontrol viskositas
                  optimal serta stabilisasi surfaktan dalam produk deterjen
                  industrial.
                </p>
        ...
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            ...
            <p
              class="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto font-body"
            >
              Siap melayani kebutuhan garam industri dan konsumsi Anda.
              Konsultasi gratis untuk spesifikasi khusus dan penawaran terbaik
            </p>
          </div>
                ...
                <div class="flex items-start space-x-6">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 font-body mb-4">
                      Hubungi langsung via WhatsApp untuk respon cepat dan
                      diskusi real-time mengenai kebutuhan produk Anda
                    </p>
